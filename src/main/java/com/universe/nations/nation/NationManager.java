...
public class NationManager {
    ...
    public NationInfo createNation(UUID ownerUuid, String rawName) {
        ...
        NationInfo nation = new NationInfo(UUID.randomUUID(), name, ownerUuid, NationLevel.HAMLET.id, System.currentTimeMillis());
